...
namespace TeamE_Project.Controllers
{
    public class UtilizadorsController : Controller
    {
        ...
        public UtilizadorsController(DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id")] Utilizador utilizador)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id")] Utilizador utilizador)
        {
            if (id != utilizador.Id)
            {
                return NotFound();
